...
import org.chomookun.arch4j.batch.common.item.file.DelimiterFileItemWriter;
import org.chomookun.arch4j.batch.common.item.file.DelimiterFileItemWriterBuilder;
import org.chomookun.arch4j.batch.common.item.file.FixedByteFileItemReader;
import org.chomookun.arch4j.batch.common.item.file.FixedByteFileItemReaderBuilder;
import org.chomookun.arch4j.batch.sample.dto.SampleBackupFile;
import org.chomookun.arch4j.batch.sample.dto.SampleFile;
import org.chomookun.arch4j.batch.sample.tasklet.CompareSampleFileToSampleBackupFileTasklet;
import org.chomookun.arch4j.batch.sample.tasklet.CreateSampleFileTasklet;
...
//                .next(compareSampleFileToSampleBackupFileStep())
    ...
    Step createSampleFileStep() {
        return getStepBuilder("createSampleFileStep")
                .tasklet(createSampleFileTasklet(null, null, null, null, null), getTransactionManager())
