...
@NoArgsConstructor
@AllArgsConstructor
public class SampleBackup extends SystemFieldSupport {

    public enum SampleBackupType {
        A, B
    }

    static class SampleTypeConverter extends AbstractEnumConverter<SampleBackupType> {}
