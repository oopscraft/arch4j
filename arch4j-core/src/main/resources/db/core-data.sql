-- user
insert into `core_user` (`user_id`,`username`,`password`,`name`,`admin`,`status`,`mobile`) values
    ('35db23b70f3940819d1965a891cbbef0','admin@oopscraft.org','{noop}admin','Administrator','Y','ACTIVE','{noop}010-1234-5678'),
    ('27b91369bdee4e1ab77a2cecb70384ec','developer@oopscraft.org','{noop}developer','Developer','N','ACTIVE', null),
    ('5e676016aa644a6cb5f4e1fd4a469dce','user@oopscraft.org','{noop}user','User','N','ACTIVE', '{noop}010-1111-2222');

-- authority
insert into `core_authority` (`authority_id`,`system_required`,`name`) values
    ('ADMIN','Y','Admin Access Authority'),
    ('ADMIN_MONITOR','Y','Admin Monitor Access Authority'),
    ('ADMIN_SECURITY','Y','Admin Security Access Authority'),
    ('ADMIN_SECURITY_EDIT','Y','Admin Security Edit Authority'),
    ('ADMIN_MENUS','Y','Admin Menus Access Authority'),
    ('ADMIN_MENUS_EDIT','Y','Admin Menus Edit Authority'),
    ('ADMIN_BOARDS','Y','Admin Boards Access Authority'),
    ('ADMIN_BOARDS_EDIT','Y','Admin Boards Edit Authority'),
    ('ADMIN_PAGES','Y','Admin Pages Access Authority'),
    ('ADMIN_PAGES_EDIT','Y','Admin Pages Edit Authority'),
    ('ADMIN_GITS','Y','Admin Gits Access Authority'),
    ('ADMIN_GITS_EDIT','Y','Admin Gits Edit Authority'),
    ('ADMIN_EMAILS','Y','Admin Emails Access Authority'),
    ('ADMIN_EMAILS_EDIT','Y','Admin Emails Edit Authority'),
    ('ADMIN_MESSAGES','Y','Admin Messages Access Authority'),
    ('ADMIN_MESSAGES_EDIT','Y','Admin Messages Edit Authority'),
    ('ADMIN_VARIABLES','Y','Admin Variables Access Authority'),
    ('ADMIN_VARIABLES_EDIT','Y','Admin Variables Edit Authority'),
    ('ADMIN_CODES','Y','Admin Codes Access Authority'),
    ('ADMIN_CODES_EDIT','Y','Admin Codes Edit Authority'),
    ('ADMIN_ALARMS','Y','Admin Alarms Access Authority'),
    ('ADMIN_ALARMS_EDIT','Y','Admins Alarm Edit Authority'),
    ('ACTUATOR','Y','Actuator Access Authority'),
    ('H2-CONSOLE','Y','Actuator Access Authority'),
    ('SWAGGER-UI','Y','Swagger UI Access Authority');

-- role
insert into `core_role` (`role_id`,`system_required`,`name`,`anonymous`, `authenticated`, `note`) values
    ('ANONYMOUS','N','Anonymous','Y','Y','Anonymous Role'),
    ('DEVELOPER','N','Developer','N','Y','User Role');
...
-- menu
insert into `core_menu` (`menu_id`,`parent_menu_id`,`name`,`link`,`target`,`sort`,`icon`) values
...
-- menu_i18n
insert into `core_menu_i18n` (`menu_id`,`language`,`name`) values
