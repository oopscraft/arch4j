...
insert into `core_board_language` (
    `board_id`,
    `language`,
    `board_name`,
    `message`
...
insert into `core_menu_language` (`menu_id`,`language`,`menu_name`) values
