...
insert into `core_authority` (`authority_id`,`system_required`,`authority_name`) values ('ADMIN_ROLE','Y','Role Access Authority');
...
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_USER');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_ROLE');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_MENU');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_BOARD');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_PAGE');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_GIT');
insert into `core_role_authority` (`role_id`,`authority_id`) values ('DEVELOPER', 'ADMIN_EMAIL');
