...
insert into `user` (`id`,`username`,`email`,`mobile`,`password`,`nickname`,`type`,`status`) values ('api','api','api@oopscraft.org','010-2222-3333','{noop}api','API Account','GENERAL','ACTIVE');
