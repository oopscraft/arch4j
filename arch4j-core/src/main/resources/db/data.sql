...
insert into `authority` (`id`,`system_required`,`name`) values ('ADMIN_PROPERTY','Y','Variable Access Authority');
insert into `authority` (`id`,`system_required`,`name`) values ('ADMIN_PROPERTY_EDIT','Y','Variable Edit Authority');
