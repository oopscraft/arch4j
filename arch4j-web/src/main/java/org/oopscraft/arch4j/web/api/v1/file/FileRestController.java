...
import org.oopscraft.arch4j.web.api.v1.board.ArticleFileResponse;
...
//
//    @PostMapping()
//    public ResponseEntity<ArticleFileResponse> saveFile(@RequestParam("file") MultipartFile multipartFile) {
...
//        }
//        ArticleFileResponse fileInfoResponse = ArticleFileResponse.from(fileInfo);
